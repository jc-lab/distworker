...
func (r *TaskRepository) List(ctx context.Context, filter database.TaskFilter, page, limit int) ([]*models.Task, int64, error) {
	// Build filter
	mongoFilter := bson.M{}
	if filter.Queue != "" {
...
func (r *TaskRepository) GetPendingTasks(ctx context.Context, queue string, limit int) ([]*models.Task, error) {
	filter := bson.M{
...
func (r *QueueRepository) GetByName(ctx context.Context, name string) (*models.Queue, error) {
...
func (r *WorkerSessionRepository) Create(ctx context.Context, session *models.WorkerSession) error {
	_, err := r.db.WorkerSessionsCollection().InsertOne(ctx, session)
	return err
}

// GetById retrieves a worker session by ID
func (r *WorkerSessionRepository) GetByID(ctx context.Context, workerId string) (*models.WorkerSession, error) {
...
func (r *WorkerSessionRepository) Update(ctx context.Context, session *models.WorkerSession) error {
...
func (r *WorkerSessionRepository) List(ctx context.Context) ([]*models.WorkerSession, error) {
	...
	var sessions []*models.WorkerSession
