...
const (
	...
	MessageType_MESSAGE_TYPE_WORKER_REGISTER MessageType = 1
	MessageType_MESSAGE_TYPE_HEARTBEAT       MessageType = 2
	MessageType_MESSAGE_TYPE_TASK_ASSIGN     MessageType = 3
	MessageType_MESSAGE_TYPE_TASK_PROGRESS   MessageType = 4
	MessageType_MESSAGE_TYPE_TASK_COMPLETE   MessageType = 5
	MessageType_MESSAGE_TYPE_TASK_FAILED     MessageType = 6
)
...
var (
	MessageType_name = map[int32]string{
		...
		1: "MESSAGE_TYPE_WORKER_REGISTER",
		2: "MESSAGE_TYPE_HEARTBEAT",
		3: "MESSAGE_TYPE_TASK_ASSIGN",
		4: "MESSAGE_TYPE_TASK_PROGRESS",
		5: "MESSAGE_TYPE_TASK_COMPLETE",
		6: "MESSAGE_TYPE_TASK_FAILED",
	}
	MessageType_value = map[string]int32{
		"MESSAGE_TYPE_UNSPECIFIED":     0,
		"MESSAGE_TYPE_WORKER_REGISTER": 1,
		"MESSAGE_TYPE_HEARTBEAT":       2,
		"MESSAGE_TYPE_TASK_ASSIGN":     3,
		"MESSAGE_TYPE_TASK_PROGRESS":   4,
		"MESSAGE_TYPE_TASK_COMPLETE":   5,
		"MESSAGE_TYPE_TASK_FAILED":     6,
	}
)
...
const (
	...
	WorkerStatus_WORKER_STATUS_PROCESSING    WorkerStatus = 2
	WorkerStatus_WORKER_STATUS_DISCONNECTING WorkerStatus = 3
...
var (
	WorkerStatus_name = map[int32]string{
		...
		2: "WORKER_STATUS_PROCESSING",
		3: "WORKER_STATUS_DISCONNECTING",
		4: "WORKER_STATUS_ERROR",
	}
	WorkerStatus_value = map[string]int32{
		"WORKER_STATUS_UNSPECIFIED":   0,
		"WORKER_STATUS_IDLE":          1,
		"WORKER_STATUS_PROCESSING":    2,
		"WORKER_STATUS_DISCONNECTING": 3,
...
type SignedWorkerRegister struct {
	...
	Date          string                 `protobuf:"bytes,2,opt,name=date,proto3" json:"date,omitempty"`                                        // 20220830T123600Z 형식
	QueuePatterns []string               `protobuf:"bytes,3,rep,name=queue_patterns,json=queuePatterns,proto3" json:"queue_patterns,omitempty"` // Queue 패턴 목록
...
func (x *SignedWorkerRegister) GetQueuePatterns() []string {
	if x != nil {
...
type Heartbeat struct {
	...
	Status        WorkerStatus           `protobuf:"varint,2,opt,name=status,proto3,enum=kr.jclab.distworker.protocol.WorkerStatus" json:"status,omitempty"` // Worker 상태
...
type ResourceInfo struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CpuCores      int32                  `protobuf:"varint,1,opt,name=cpu_cores,json=cpuCores,proto3" json:"cpu_cores,omitempty"` // CPU 코어 수
	MemoryMb      int64                  `protobuf:"varint,2,opt,name=memory_mb,json=memoryMb,proto3" json:"memory_mb,omitempty"` // 메모리 (MiB)
	Additional    *structpb.Struct       `protobuf:"bytes,3,opt,name=additional,proto3" json:"additional,omitempty"`              // 추가 리소스 정보
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type WebSocketMessage_TaskAssign struct {
	TaskAssign *TaskAssign `protobuf:"bytes,4,opt,name=task_assign,json=taskAssign,proto3,oneof"`
}
...
type WebSocketMessage_TaskComplete struct {
	TaskComplete *TaskComplete `protobuf:"bytes,6,opt,name=task_complete,json=taskComplete,proto3,oneof"`
}

type WebSocketMessage_TaskFailed struct {
	TaskFailed *TaskFailed `protobuf:"bytes,7,opt,name=task_failed,json=taskFailed,proto3,oneof"`
}
...
const file_proto_protocol_proto_rawDesc = "" +
	"\n" +
	"\x14proto/protocol.proto\x12\x1ckr.jclab.distworker.protocol\x1a\x1cgoogle/protobuf/struct.proto\"B\n" +
	"\x0eWorkerRegister\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12\x1c\n" +
	"\tsignature\x18\x02 \x01(\fR\tsignature\"\xbf\x01\n" +
	"\x14SignedWorkerRegister\x12\x1b\n" +
	"\tworker_id\x18\x01 \x01(\tR\bworkerId\x12\x12\n" +
	"\x04date\x18\x02 \x01(\tR\x04date\x12%\n" +
	"\x0equeue_patterns\x18\x03 \x03(\tR\rqueuePatterns\x12O\n" +
	...
	"\x06status\x18\x02 \x01(\x0e2*.kr.jclab.distworker.protocol.WorkerStatusR\x06status\x12R\n" +
	"\x0eresource_usage\x18\x03 \x01(\v2+.kr.jclab.distworker.protocol.ResourceUsageR\rresourceUsage\"\x81\x01\n" +
	"\fResourceInfo\x12\x1b\n" +
	"\tcpu_cores\x18\x01 \x01(\x05R\bcpuCores\x12\x1b\n" +
	"\tmemory_mb\x18\x02 \x01(\x03R\bmemoryMb\x127\n" +
	"\n" +
	...
	"\x0fworker_register\x18\x02 \x01(\v2,.kr.jclab.distworker.protocol.WorkerRegisterH\x00R\x0eworkerRegister\x12G\n" +
	"\theartbeat\x18\x03 \x01(\v2'.kr.jclab.distworker.protocol.HeartbeatH\x00R\theartbeat\x12K\n" +
	"\vtask_assign\x18\x04 \x01(\v2(.kr.jclab.distworker.protocol.TaskAssignH\x00R\n" +
	"taskAssign\x12Q\n" +
	"\rtask_progress\x18\x05 \x01(\v2*.kr.jclab.distworker.protocol.TaskProgressH\x00R\ftaskProgress\x12Q\n" +
	"\rtask_complete\x18\x06 \x01(\v2*.kr.jclab.distworker.protocol.TaskCompleteH\x00R\ftaskComplete\x12K\n" +
	"\vtask_failed\x18\a \x01(\v2(.kr.jclab.distworker.protocol.TaskFailedH\x00R\n" +
	"taskFailedB\t\n" +
	"\apayload*\xe5\x01\n" +
...
var file_proto_protocol_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_proto_protocol_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_proto_protocol_proto_goTypes = []any{
	(MessageType)(0),             // 0: kr.jclab.distworker.protocol.MessageType
	(WorkerStatus)(0),            // 1: kr.jclab.distworker.protocol.WorkerStatus
	(TaskStatus)(0),              // 2: kr.jclab.distworker.protocol.TaskStatus
	(*WorkerRegister)(nil),       // 3: kr.jclab.distworker.protocol.WorkerRegister
	(*SignedWorkerRegister)(nil), // 4: kr.jclab.distworker.protocol.SignedWorkerRegister
	(*TaskAssign)(nil),           // 5: kr.jclab.distworker.protocol.TaskAssign
	(*TaskProgress)(nil),         // 6: kr.jclab.distworker.protocol.TaskProgress
	(*TaskComplete)(nil),         // 7: kr.jclab.distworker.protocol.TaskComplete
	(*TaskFailed)(nil),           // 8: kr.jclab.distworker.protocol.TaskFailed
	(*Heartbeat)(nil),            // 9: kr.jclab.distworker.protocol.Heartbeat
	(*ResourceInfo)(nil),         // 10: kr.jclab.distworker.protocol.ResourceInfo
	(*ResourceUsage)(nil),        // 11: kr.jclab.distworker.protocol.ResourceUsage
	(*FileInfo)(nil),             // 12: kr.jclab.distworker.protocol.FileInfo
	(*WebSocketMessage)(nil),     // 13: kr.jclab.distworker.protocol.WebSocketMessage
	(*structpb.Struct)(nil),      // 14: google.protobuf.Struct
}
var file_proto_protocol_proto_depIdxs = []int32{
	10, // 0: kr.jclab.distworker.protocol.SignedWorkerRegister.resource_info:type_name -> kr.jclab.distworker.protocol.ResourceInfo
	14, // 1: kr.jclab.distworker.protocol.TaskAssign.metadata:type_name -> google.protobuf.Struct
	14, // 2: kr.jclab.distworker.protocol.TaskAssign.input:type_name -> google.protobuf.Struct
	12, // 3: kr.jclab.distworker.protocol.TaskAssign.files:type_name -> kr.jclab.distworker.protocol.FileInfo
	14, // 4: kr.jclab.distworker.protocol.TaskProgress.data:type_name -> google.protobuf.Struct
	14, // 5: kr.jclab.distworker.protocol.TaskComplete.result:type_name -> google.protobuf.Struct
	12, // 6: kr.jclab.distworker.protocol.TaskComplete.result_files:type_name -> kr.jclab.distworker.protocol.FileInfo
	14, // 7: kr.jclab.distworker.protocol.TaskFailed.error_details:type_name -> google.protobuf.Struct
	1,  // 8: kr.jclab.distworker.protocol.Heartbeat.status:type_name -> kr.jclab.distworker.protocol.WorkerStatus
	11, // 9: kr.jclab.distworker.protocol.Heartbeat.resource_usage:type_name -> kr.jclab.distworker.protocol.ResourceUsage
	14, // 10: kr.jclab.distworker.protocol.ResourceInfo.additional:type_name -> google.protobuf.Struct
	14, // 11: kr.jclab.distworker.protocol.ResourceUsage.additional:type_name -> google.protobuf.Struct
	...
	9,  // 14: kr.jclab.distworker.protocol.WebSocketMessage.heartbeat:type_name -> kr.jclab.distworker.protocol.Heartbeat
	5,  // 15: kr.jclab.distworker.protocol.WebSocketMessage.task_assign:type_name -> kr.jclab.distworker.protocol.TaskAssign
	6,  // 16: kr.jclab.distworker.protocol.WebSocketMessage.task_progress:type_name -> kr.jclab.distworker.protocol.TaskProgress
	7,  // 17: kr.jclab.distworker.protocol.WebSocketMessage.task_complete:type_name -> kr.jclab.distworker.protocol.TaskComplete
	8,  // 18: kr.jclab.distworker.protocol.WebSocketMessage.task_failed:type_name -> kr.jclab.distworker.protocol.TaskFailed
...
func file_proto_protocol_proto_init() {
	...
	file_proto_protocol_proto_msgTypes[10].OneofWrappers = []any{
